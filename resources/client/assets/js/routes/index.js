...
import RendezvousesIndex from '../components/cruds/Rendezvouses/Index.vue'
import RendezvousesCreate from '../components/cruds/Rendezvouses/Create.vue'
import RendezvousesShow from '../components/cruds/Rendezvouses/Show.vue'
import RendezvousesEdit from '../components/cruds/Rendezvouses/Edit.vue'
...
const routes = [
    ...
    { path: '/rendezvouses', component: RendezvousesIndex, name: 'rendezvouses.index' },
    { path: '/rendezvouses/create', component: RendezvousesCreate, name: 'rendezvouses.create' },
    { path: '/rendezvouses/:id', component: RendezvousesShow, name: 'rendezvouses.show' },
    { path: '/rendezvouses/:id/edit', component: RendezvousesEdit, name: 'rendezvouses.edit' },
]
