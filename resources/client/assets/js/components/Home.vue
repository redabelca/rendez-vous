<template>
  <div>
    <div class="panel-header panel-header-lg" style="height:70vh;">
      <canvas ref="bigDashboardChart"></canvas>
    </div>
    <div class="d-flex" style="height:30vh;">
      <div class="m-auto">
        <router-link
          :to="{name:'rendezvouses.index'}"
          class="btn btn-lg btn-primary"
        >Liste des Rendez Vous</router-link>
      </div>
    </div>
  </div>
</template>
...
export default {
  // props: ["qa_dashboard", "qa_dashboard_text"]
  mounted() {
  ...
  methods: {
    initDashboardPageCharts() {
      ...
      var ctx = this.$refs.bigDashboardChart.getContext("2d");
          ...
          datasets: [
            {
              ...
              borderWidth: 2,
              data: [50, 10, 30, 36, 100, 50, 9, 1, 49, 110, 40, 70]
            }
          ]
        },
        options: {
