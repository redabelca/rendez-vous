        ...
        <section class="content">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="btn-group">
                            <router-link v-if="$can(xprops.permission_prefix + 'create')" :to="{ name: xprops.route + '.create' }" class="btn btn-success btn-sm">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters('RendezvousesIndex', ['data', 'total', 'loading', 'relationships']),
        },
        watch: {
            query: {
                handler(query) {
        ...
        methods: {
            ...mapActions('RendezvousesIndex', ['fetchData', 'setQuery', 'resetState']),
        }
    }
